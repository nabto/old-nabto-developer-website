...
title: 'Get started for C#/.NET Clients'
permalink: /developer/guides/get-started/get-started-c-net-clients.html
...
in_subcollapse: 'C#/.NET Clients'


# Smooth Scroll List
anchor-list:
  - title: 'Get started for Android clients'
    id: '#set-up-an-android-client'
